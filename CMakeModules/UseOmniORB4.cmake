...
IF (NOT OMNIORB4_DIR)
  ...
  #A verification procedure so as to check that omniORB is truly installed
  FIND_PATH(SEARCH_OMNI_LIBS
	NAMES	libomniORB4.so libomnithread.so libomniDynamic4.so
	HINTS   "${OMNIORB4_DIR}/include;${OMNIORB4_DIR}/lib"
  )
 
#If not, back to square one
  IF("${SEARCH_OMNI_LIBS}" STREQUAL "SEARCH_OMNI_LIBS-NOTFOUND")	
	SET(omniORB4_include_DIR )
	SET(omniORB4_link_DIR )
	SET(omniORB4_link_FLAGS )
	SET(omniORB4_cflags )
	SET(omniORB4_IDLC )
	SET(OMNIORB4_DIR )
#If we have found them,  set the data
  ELSE("${SEARCH_OMNI_LIBS}" STREQUAL "SEARCH_OMNI_LIBS-NOTFOUND")
  ...
  ENDIF("${SEARCH_OMNI_LIBS}" STREQUAL "SEARCH_OMNI_LIBS-NOTFOUND")
...
IF(OMNIORB4_DIR)
  ...
  MACRO(IDLFILERULE IDLFILE TargetFile_CPP TargetFile_Header IDL_WORKING_DIR IDL_INCLUDE_DIR)
    ...
    SET(commandtorealize ${omniORB4_IDLC} ${optionslcustomcommand} -C${${PROJECT_NAME}_BINARY_DIR}/stubs -bcxx -Wbh=\".h\" ${IDLFILE})
